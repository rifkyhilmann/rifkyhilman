...
import image1 from '../../../assets/images/app apotek images/login user.png';
import image2 from '../../../assets/images/app apotek images/dashboard user.png';
import image3 from '../../../assets/images/app apotek images/product user.png';
import image4 from '../../../assets/images/app apotek images/pesanan user.png';
import image5 from '../../../assets/images/app apotek images/keranjang user.png';
            ...
            <div className={`menu-container w-full h-screen flex ${mode ? 'bg-ContentDark-500 text-white' : 'bg-gray-100 text-black'}`}>
                <div className="menu-container flex flex-col w-full h-max items-center mt-28">
                    <p className="text-sm sm:text-lg w-10/12 flex justify-center text-center mb-10">
                        App Apotek is a website that has been built to assist companies in managing their data
                        . the menus/features devloped are tailored to the specific needs of company
                    </p>
                    <div className={`card-project h-52  ${mode ? 'bg-NavbarDark-900' : 'white shadow-lg'} flex rounded gap-7`}>
                        <div className="card-project-images w-full ">
                            ...
                            >
                                ...
                                <div className="h-full">
                                    <img src={image4} alt="Image 3" className="images-card rounded object-contain" />
                                </div>
                                <div className="h-full">
                                    <img src={image5} alt="Image 3" className="images-card rounded object-contain" />
                                </div>
                            </Carousel>
                        </div>
                        <div className={`card-project-info flex flex-col justify-center gap-1  `}>
                            ...
                            <div className="  flex items-center gap-4 mt-5">
                                <a 
                                    href="https://github.com/RifkyHilman1302/app-apotek-laravel" 
                                    target="blank"
